...
public class DataStream {
     ...
     * @return
     */
    public static List<NtDataSourceVO> read(String path) throws Exception {
        List<NtDataSourceVO> ntDataSources = TxtParseUtils.read(path);
        for (NtDataSourceVO ntDataSource : ntDataSources) {
