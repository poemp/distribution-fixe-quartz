...
import org.poem.nt.NtDataSourceVO;
...
public class TxtParseUtils {
    ...
    private static List<String> getFiled() {
        Class clazz = NtDataSourceVO.class;
     ...
     * @return
     */
    public static List<NtDataSourceVO> read(String name) {
        // 使用ArrayList来存储每行读取到的字符串
        List<NtDataSourceVO> ntDataSources = Lists.newArrayList();
        ...
        try {
            ...
            String str, line;
            NtDataSourceVO ntDataSource = null;
            int lastIndex = -1;
            while ((line = bf.readLine()) != null) {
                ...
                if (line.startsWith(firstFiled)) {
                    ...
                    lastIndex = -1;
                    ntDataSource = new NtDataSourceVO();
                }
